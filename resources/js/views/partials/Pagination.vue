    ...
    <div>
        <nav aria-label="Page navigation example">
            ...
            <ul class="pagination justify-content-center">
                ...
                <li style="cursor:pointer" class="page-item" v-for="page in pages"  :key="page" :class="isCurrentPage(page) ? 'active' : ''">
                ...
                <li style="cursor:pointer" class="page-item" :class="{ disabled: pagination.current_page >= pagination.last_page }">
